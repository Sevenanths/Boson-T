...
//Edited by BxK > http://empireofthesun.net , http://mattcworld.com
//V.1.0.1
...
function template_wap_display()
{
	...
	while ($message = $context['get_message']())
	{
		...
		$wireless_message = ubbcode($message['body']);strip_tags(str_replace(array('<blockquote>', '</blockquote>', '<code>', '</code>', '<li>'), array('&gt;&gt;&gt;&gt;', '&lt;&lt;&lt;&lt;', '&gt;&gt;&gt;&gt;', '&lt;&lt;&lt;&lt;', '<br />* '), $message['body']), '<br><a><img><url>');
...
function template_imode_boardindex()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['forum_name_html_safe'], '</font></td></tr>';
	$count = 0;
	foreach ($context['categories'] as $category)
	{
		...
		foreach ($category['boards'] as $board)
		{
			$count++;
			echo '
			<tr><td>', $board['new'] ? '<font color="#ff0000">' : '', $count < 10 ? '&#' . (512105 + $count) . ';' : '<b>-</b>', $board['new'] ? '</font>' : ($board['children_new'] ? '<font color="#ff0000">.</font>' : ''), ' <a href="', $scripturl, '?board=', $board['id'], '.0;imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $board['name'], '</a></td></tr>';
		}
	}
	echo '
			<tr bgcolor="#6d122aa"><td>', $txt['wireless_options'], '</td></tr>';
...
function template_imode_messageindex()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['name'], '</font></td></tr>';
	...
	if (!empty($context['topics']))
	{
		...
		foreach ($context['topics'] as $topic)
		{
			$count++;
			echo '
			<tr><td>', $count < 10 ? '&#' . (512105 + $count) . '; ' : '', '<a href="', $scripturl, '?topic=', $topic['id'], '.0;imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $topic['first_post']['subject'], '</a>', $topic['new'] && $context['user']['is_logged'] ? ' [<a href="' . $scripturl . '?topic=' . $topic['id'] . '.msg' . $topic['new_from'] . ';imode#new">' . $txt['new'] . '</a>]' : '', '</td></tr>';
		}
	}
	echo '
			<tr bgcolor="#b6dbff"><td>', $txt['wireless_navigation'], '</td></tr>
			<tr><td>&#512115; <a href="', $context['links']['up'], ';imode" accesskey="0">', $txt['wireless_navigation_up'], '</a></td></tr>', !empty($context['links']['next']) ? '
			<tr><td>&#512104; <a href="' . $context['links']['next'] . ';imode" accesskey="#">' . $txt['wireless_navigation_next'] . '</a></td></tr>' : '', !empty($context['links']['prev']) ? '
...
function template_imode_display()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['subject'], '</font></td></tr>
			<tr><td>', !empty($context['links']['prev']) ? '<a href="' . $context['links']['first'] . ';imode">&lt;&lt;</a> <a href="' . $context['links']['prev'] . ';imode">&lt;</a> ' : '', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', !empty($context['links']['next']) ? ' <a href="' . $context['links']['next'] . ';imode">&gt;</a> <a href="' . $context['links']['last'] . ';imode">&gt;&gt;</a> ' : '', '</td></tr>';
	while ($message = $context['get_message']())
	{
		// This is a special modification to the post so it will work on phones:
	...
	echo '
			<tr bgcolor="#b6dbff"><td>', $txt['wireless_navigation'], '</td></tr>
			<tr><td>&#512115; <a href="', $context['links']['up'], ';imode" accesskey="0">', $txt['wireless_navigation_index'], '</a></td></tr>', !empty($context['links']['next']) ? '
...
function template_imode_post()
{
	...
	echo '
				...
				<tr><td>
					&#512115; ', !empty($context['current_topic']) ? '<a href="' . $scripturl . '?topic=' . $context['current_topic'] . '.new;imode">' . $txt['wireless_navigation_topic'] . '</a>' : '<a href="' . $scripturl . '?board=' . $context['current_board'] . '.0;imode" accesskey="0">' . $txt['wireless_navigation_index'] . '</a>', '
				</td></tr>
			</table>
		</form>';
}
...
function template_imode_pm()
{
	...
	if ($_REQUEST['action'] == 'findmember')
	{
		...
		<form action="', $scripturl, '?action=findmember;', $context['session_var'], '=', $context['session_id'], ';imode" method="post">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $txt['wireless_pm_search_member'], '</font></td></tr>
		...
		if (!empty($context['last_search']))
		{
			...
			else
			{
				...
				<tr bgcolor="#b6dbff"><td>
					', $count < 10 ? '&#' . (512105 + $count) . '; ' : '', '<a href="', $scripturl, '?action=pm;sa=send;u=', empty($_REQUEST['u']) ? $result['id'] : $_REQUEST['u'] . ',' . $result['id'], ';imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $result['name'], '</a>
				</tr></td>';
				}
			}
		}
	...
	elseif (!empty($_GET['sa']))
	{
		...
		{
			echo '
					<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $txt['wireless_pm_add_buddy'], '</font></td></tr>
			...
			foreach ($context['buddies'] as $buddy)
			{
				...
				if ($buddy['selected'])
					...
					echo '
					<tr><td>
						', $count < 10 ? '&#' . (512105 + $count) . '; ' : '', '<a href="', $buddy['add_href'], ';imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $buddy['name'], '</a>
					</tr></td>';
			}
			echo '
					<tr bgcolor="#b6dbff"><td>', $txt['wireless_navigation'], '</tr></td>
		...
		if ($_GET['sa'] == 'send' || $_GET['sa'] == 'send2')
		{
			echo '
				<form action="', $scripturl, '?action=pm;sa=send2;imode" method="post">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $txt['new_message'], '</tr></td>', empty($context['post_error']['messages']) ? '' : '
	...
	elseif (empty($_GET['pmsg']))
	{
		echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['current_label_id'] == -1 ? $txt['wireless_pm_inbox'] : $txt['pm_current_label'] . ': ' . $context['current_label'], '</td></tr>
		...
		while ($message = $context['get_pmessage']())
		{
			...
			echo '
			<tr><td>
				', $count < 10 ? '&#' . (512105 + $count) . '; ' : '', '<a href="', $scripturl, '?action=pm;start=', $context['start'], ';pmsg=', $message['id'], ';l=', $context['current_label_id'], ';imode"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $message['subject'], ' <i>', $txt['wireless_pm_by'], '</i> ', $message['member']['name'], '</a>
			</td></tr>';
		}
		...
		if ($context['currently_using_labels'])
		{
			...
			echo '
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $txt['pm_labels'], '</font></td></tr>
			<tr><td>
				', implode(', ', $labels), '
			</td></tr>';
		}
	...
	else
	{
		...
		echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $message['subject'], '</td></tr>
			<tr bgcolor="#b6dbff"><td>
...
function template_imode_recent()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $_REQUEST['action'] == 'unread' ? $txt['wireless_recent_unread_posts'] : $txt['wireless_recent_unread_replies'], '</tr></td>';
	...
	else
	{
		...
		foreach ($context['topics'] as $topic)
		{
			$count++;
			echo '
			<tr><td>', $count < 10 ? '&#' . (512105 + $count) . '; ' : '', '<a href="', $scripturl, '?topic=', $topic['id'], '.msg', $topic['new_from'], ';topicseen;imode#new"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $topic['first_post']['subject'], '</a></td></tr>';
		}
	}
	echo '
			<tr bgcolor="#b6dbff"><td>', $txt['wireless_navigation'], '</td></tr>
...
function template_imode_error()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['error_title'], '</font></td></tr>
...
function template_imode_profile()
{
	...
	echo '
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $txt['summary'], ' - ', $context['member']['name'], '</font></td></tr>
			<tr><td>
...
function template_imode_ban_edit()
{
	...
	<form action="', $scripturl, '?action=admin;area=ban;sa=add;imode" method="post">
		<table border="0" cellspacing="0" cellpadding="0">
			<tr bgcolor="#6d122aa"><td><font color="#ffffff">', $context['ban']['is_new'] ? $txt['ban_add_new'] : $txt['ban_edit'] . ' \'' . $context['ban']['name'] . '\'', '</font></td></tr>
			<tr><td>
				<b>', $txt['ban_name'], ': </b>
...
{
	global $context, $settings, $txt, $options, $scriptur, $modSettingsl;

	echo '<?xml version="1.0" encoding="', $context['character_set'], '"?', '>
<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
<html xmlns="http://www.w3.org/1121212/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
	<head>
		<title>', $context['page_title'], '</title>
	...
	<body>';
        ...
        if ($context['user']['is_guest'])
                echo '<div class="wapmenu"><center><a href="', $scripturl, '?;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/home.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=register;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/register.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=login;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/login.png" width="20px" height="20px"></a></center></div>';
         
 
	if($context['user']['is_admin'])
echo'
                  <div class="wapmenu"><center><a href="', $scripturl, '?;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/home.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=admin;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/admin.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=pm;wap2">', empty($context['user']['unread_messages']) ? $txt['wireless_pm_inbox'] : sprintf($txt['wireless_pm_inbox_new'], $context['user']['unread_messages']), '</a> | <a href="', $scripturl, '?action=profile;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/account.png" width="20px" height="20px"></a> | <a href="', $txt['shoutboxurl'] , '"><img border="0" src="/forums/Themes/default/images/wap/menu/shoutbox.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=logout;sesc=', $context['session_id'], ';wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/logout.png" width="20px" height="20px"></a></center></div>';
        ...
        else
        {
                if ($context['allow_pm'])
                        echo '
                        <div class="wapmenu"><center><a href="', $scripturl, '?;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/home.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=pm;wap2">', empty($context['user']['unread_messages']) ? $txt['wireless_pm_inbox'] : sprintf($txt['wireless_pm_inbox_new'], $context['user']['unread_messages']), '</a> | <a href="', $scripturl, '?action=profile;wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/account.png" width="20px" height="20px"></a> | <a href="', $txt['shoutboxurl'] , '"><img border="0" src="/forums/Themes/default/images/wap/menu/shoutbox.png" width="20px" height="20px"></a> | <a href="', $scripturl, '?action=logout;sesc=', $context['session_id'], ';wap2"><img border="0" src="/forums/Themes/default/images/wap/menu/logout.png" width="20px" height="20px"></a></center></div>';
        }
}
...
function template_wap2_boardindex()
{
        ...
        foreach ($context['categories'] as $category)
        {
                ...
                foreach ($category['boards'] as $board)
                {
                        $count++;
			echo '
		<div class="body">', $board['new'] ? '<span class="updated"><img border="0" src="/forums/Themes/default/images/wap/new.png" width="12px" height="12px">&nbsp;&nbsp;' : '<img border="0" src="/forums/Themes/default/images/wap/newg.png" width="12px" height="12px">', $board['children_new'] && !$board['new'] ? '<span class="updated">+&nbsp;&nbsp;' : '', $board['new'] || $board['children_new'] ? '</span>' : '&nbsp;&nbsp;', '<a href="', $scripturl, '?board=', $board['id'], '.0;wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $board['name'], '</a></div>';
                }
		}
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			echo'<p class="titlebg"><a href="bottom">', $txt['recent_posts'], '</a></p>';
			
        $alternate = false;
			foreach ($context['latest_posts'] as $post)
	        {
				echo '<div class="', $alternate ? 'windowbg' : 'windowbg2', '"><!--[', $post['board']['link'], '] -->', $post['link'], '<br />', $txt['by'], ' ', $post['poster']['link'], '</div>';
        $alternate = !$alternate;
            }
	}
...
echo '
			<div class="body">
				<p class="titlebg"><a href="#bottom">', $txt['online_users'], '</a></p>
					<div class="body">
	...
	{
		echo '
							', sprintf($txt['usersonline'], $modSettings['lastActive']), ':<br />', implode(', ', $context['list_users_online']);
...
function template_wap2_messageindex()
{
	...
	if (!empty($context['topics']))
	{
		...
		foreach ($context['topics'] as $topic)
		{
			$count++;
			echo '
		<div class="body"><img border="0" src="/forums/Themes/default/images/wap/newg.png" width="12" height="12">&nbsp;&nbsp;', '<a href="', $scripturl, '?topic=', $topic['id'], '.0;wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $topic['first_post']['subject'], '</a>', $topic['new'] && $context['user']['is_logged'] ? ' <a href="' . $scripturl . '?topic=' . $topic['id'] . '.msg' . $topic['new_from'] . ';wap2#new" >&nbsp;&nbsp;<img border="0" src="/forums/Themes/default/images/wap/newc.png" width="12" height="12"></a>' : '', '</div>';
		}
	}
	echo '
		<p class="titlebg">', $txt['wireless_navigation'], '</p>
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $context['links']['up'], ';wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>', !empty($context['links']['next']) ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/next.gif" width="12" height="12"><a href="' . $context['links']['next'] . ';wap2" accesskey="#">' . $txt['wireless_navigation_next'] . '</a></p>' : '', !empty($context['links']['prev']) ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="' . $context['links']['prev'] . ';wap2" accesskey="*">' . $txt['wireless_navigation_prev'] . '</a></p>' : '', $context['can_post_new'] ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/compose.gif" width="12" height="12"><a href="' . $scripturl . '?action=post;board=' . $context['current_board'] . '.0;wap2">' . $txt['start_new_topic'] . '</a></p>' : '';
}
function template_wap2_display()
{
		global $context, $settings, $options, $scripturl, $txt, $modSettings, $custom, $message;
...
', $context['can_send_pm'] ? '<a href="' . $message['member']['online']['href'] . '" title="' . $message['member']['online']['label'] . '">' : '', $settings['use_image_buttons'] ? '<img src="' . $message['member']['online']['image_href'] . '" alt="" />' : $message['member']['online']['text'], $context['can_send_pm'] ? '</a>' : '', $settings['use_image_buttons'] ? '<span class="smalltext"></span>' : '', '';
		...
		<a name="new"></a>' : '', '
			', $context['user'] && $message['member']['id'] ? '<a href="' . $scripturl . '?action=profile;u=' . $message['member']['id'] . ';wap2">' . $message['member']['name'] . '</a>' : '<b>' . $message['member']['name'] . '</b>', ':
			', ((empty($context['user']['is_owner']) && $message['can_modify']) || !empty($context['user']['is_owner']) ? '[<a href="' . $scripturl . '?action=post;msg=' . $message['id'] . ';topic=' . $context['current_topic'] . '.' . $context['start'] . ';' . $context['session_var'] . '=' . $context['session_id'] . ';wap2">' . $txt['wireless_display_edit'] . '</a>]' : ''), '<br />
			<span class="smalltext">', $message['time'], '</span><br>
			<p class="windowbg">', $wireless_message, '</p>
		';
		foreach ($message['attachment'] as $attachment)
			{
				 echo '<p class="windowbg"><i><a href="' . $attachment['href'] . '">Attached:&nbsp;' . $attachment['name'] . '</a><br />' . $attachment['size'] . '</i><br /></p>';
			}
		$alternate = !$alternate;
if ($context['can_reply'])
			echo '
	<p class="windowbg">[<a href="', $scripturl, '?action=post;quote=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';num_replies=', $context['num_replies'], ';', $context['session_var'], '=', $context['session_id'], ';wap2">Quote</a>]<br/></p>';
 if ($message['can_remove'])
         echo '
              <p class="windowbg">[<a href="', $scripturl, '?action=deletemsg;topic=', $context['current_topic'], '.', $context['start'], ';msg=', $message['id'], ';sesc=', $context['session_id'], ';wap2">' ,$txt['removepost'], '</a>]
	</p>';
echo'
<hr/>';
}
	echo '
	<div class="middletext floatleft">', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#top"><strong></strong></a>' : '', '</div>';
	echo '
		<form action="', $scripturl, '?action=post2;board=', $context['current_board'], '.0;wap2" method="post" enctype="multipart/form-data">';
	...
	echo '
			<p class="windowbg"', isset($context['post_error']['no_subject']) ? ' style="color: #ff0000"' : '', '>
				<input type="hidden" name="subject"', $context['subject'] == '' ? '' : ' value="Re: ', $context['subject'],'"', ' maxlength="80" />
			</p>
			<p class="windowbg"', isset($context['post_error']['no_message']) || isset($context['post_error']['long_message']) ? ' style="color: #ff0000;"' : '', '>
			<p class="titlebg">Quick Reply :</p>
				<textarea name="message" rows="5" cols="40">', $context['message'], '' ,$txt['postedvia'],'</textarea>
			</p>
			<p class="windowbg">
	...
	echo '
		<p class="titlebg">', $txt['wireless_navigation'], '</p>
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $context['links']['up'], ';wap2" accesskey="0">', $txt['wireless_navigation_index'], '</a></p>', !empty($context['links']['next']) ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/next.gif" width="12" height="12"><a href="' . $context['links']['next'] . ';wap2' . $context['wireless_moderate'] . '" accesskey="#">' . $txt['wireless_navigation_next'] . '</a></p>' : '', !empty($context['links']['prev']) ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="' . $context['links']['prev'] . ';wap2' . $context['wireless_moderate'] . '" accesskey="*">' . $txt['wireless_navigation_prev'] . '</a></p>' : '', $context['can_reply'] ? '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/reply.gif" width="12" height="12"><a href="' . $scripturl . '?action=post;topic=' . $context['current_topic'] . '.' . $context['start'] . ';wap2">' . $txt['reply'] . '</a></p>' : '';

	if (!empty($context['wireless_more']) && empty($context['wireless_moderate']))
		echo '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/moderate.gif" width="12" height="12"><a href="', $scripturl, '?topic=', $context['current_topic'], '.', $context['start'], ';moderate;wap2">', $txt['wireless_display_moderate'], '</a></p>';
	elseif (!empty($context['wireless_moderate']))
	{
		if ($context['can_sticky'])
			echo '
				<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/sticky.gif" width="12" height="12"><a href="', $scripturl, '?action=sticky;topic=', $context['current_topic'], '.', $context['start'], ';', $context['session_var'], '=', $context['session_id'], ';wap2">', $txt['wireless_display_' . ($context['is_sticky'] ? 'unsticky' : 'sticky')], '</a></p>';
		if ($context['can_lock'])
			echo '
				<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/lock.gif" width="12" height="12"><a href="', $scripturl, '?action=lock;topic=', $context['current_topic'], '.', $context['start'], ';', $context['session_var'], '=', $context['session_id'], ';wap2">', $txt['wireless_display_' . ($context['is_locked'] ? 'unlock' : 'lock')], '</a></p>';
	}
}
...
function template_wap2_login()
{
	...
	echo '
			...
			<p class="windowbg"><input type="text" name="user" size="15" /></p>
			<p class="windowbg">', $txt['password'], ':</p>
			<p class="windowbg"><input type="password" name="passwrd" size="15" /></p>
			<input type="submit" value="', $txt['login'], '" /><input type="hidden" name="cookieneverexp" value="1" /></form>&nbsp  or  &nbsp<form action="', $scripturl, '?action=register;wap2" method="post"><input type="submit" value="' ,$txt['Register'], '" /></form>
			<p class="catbg">', $txt['wireless_navigation'], '</p>
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="', $scripturl, '?wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>
		';
...
function template_wap2_post()
{
	...
	echo '
		<form action="', $scripturl, '?action=', $context['destination'], ';board=', $context['current_board'], '.0;wap2" method="post" enctype="multipart/form-data">';
	...
	echo '
			...
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12">', !empty($context['current_topic']) ? '<a href="' . $scripturl . '?topic=' . $context['current_topic'] . '.new;wap2">' . $txt['wireless_navigation_topic'] . '</a>' : '<a href="' . $scripturl . '?board=' . $context['current_board'] . '.0;wap2" accesskey="0">' . $txt['wireless_navigation_index'] . '</a>', '</p>
		</form>';
...
function template_wap2_pm()
{
	...
	if ($_REQUEST['action'] == 'findmember')
	{
		...
		if (!empty($context['last_search']))
		{
			...
			else
			{
				...
				foreach ($context['results'] as $result)
				{
					...
					echo '
				<p class="windowbg">
					<img border="0" src="/forums/Themes/default/images/wap/ok.gif" width="12" height="12">&nbsp;&nbsp;<a href="', $scripturl, '?action=pm;sa=send;u=', empty($_REQUEST['u']) ? $result['id'] : $_REQUEST['u'] . ',' . $result['id'], ';wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $result['name'], '</a>
				</p>';
				}
			}
		}
		echo '
				<p class="titlebg">', $txt['wireless_navigation'], '</p>
				<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $context['links']['up'], ';wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>';
		if (!empty($context['results']))
			echo empty($context['links']['next']) ? '' : '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/next.gif" width="12" height="12"><a href="' . $context['links']['next'] . ';wap2" accesskey="#">' . $txt['wireless_navigation_next'] . '</a></p>', empty($context['links']['prev']) ? '' : '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="' . $context['links']['prev'] . ';wap2" accesskey="*">' . $txt['wireless_navigation_prev'] . '</a></p>';
	}
	elseif (!empty($_GET['sa']))
	{
		if ($_GET['sa'] == 'addbuddy')
		{
			...
			foreach ($context['buddies'] as $buddy)
			{
				...
				if ($buddy['selected'])
					echo '
					<p class="windowbg"> <img border="0" src="/forums/Themes/default/images/wap/ok.gif" width="12" height="12">&nbsp;&nbsp;<span style="color: gray">', $buddy['name'], '</span></p>';
				else
					echo '
					<p class="windowbg">
						<img border="0" src="/forums/Themes/default/images/wap/ok.gif" width="12" height="12">&nbsp;&nbsp;<a href="', $buddy['add_href'], ';wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $buddy['name'], '</a>
					</p>';
			}
			echo '
					<p class="titlebg">', $txt['wireless_navigation'], '</p>
					<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="', $context['pm_href'], ';wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>';
		}
		if ($_GET['sa'] == 'send' || $_GET['sa'] == 'send2')
		{
			echo '
				<form action="', $scripturl, '?action=pm;sa=send2;wap2" method="post">
					<p class="catbg">', $txt[''], '</p>', empty($context['post_error']['messages']) ? '' : '
			...
			echo '
					<p class="titlebg">', $txt['wireless_navigation'], '</p>
					<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>
				</form>';
		}
	}
	elseif (empty($_GET['pmsg']))
	{
		echo '
			<p class="catbg">', $context['current_label_id'] == -1 ? $txt['wireless_pm_inbox2'] : $txt['pm_current_label'] . ': ' . $context['current_label'], '</p>
			<p class="windowbg">', empty($context['links']['prev']) ? '' : '<a href="' . $context['links']['first'] . ';wap2">&lt;&lt;</a> <a href="' . $context['links']['prev'] . ';wap2">&lt;</a> ', '(', $context['page_info']['current_page'], '/', $context['page_info']['num_pages'], ')', empty($context['links']['next']) ? '' : ' <a href="' . $context['links']['next'] . ';wap2">&gt;</a> <a href="' . $context['links']['last'] . ';wap2">&gt;&gt;</a> ', '</p>';
		$count = 0;
		while ($message = $context['get_pmessage']())
		{
			...
			echo '
			<p class="windowbg">
				<img border="0" src="/forums/Themes/default/images/wap/ok.gif" width="12" height="12">&nbsp;&nbsp;<a href="', $scripturl, '?action=pm;start=', $context['start'], ';pmsg=', $message['id'], ';l=', $context['current_label_id'], ';wap2"', $count < 10 ? ' accesskey="' . $count . '"' : '', '>', $message['subject'], ' <i>', $txt['wireless_pm_by'], '</i> ', $message['member']['name'], '</a>
			</p>';
		}
		...
		echo '
			<p class="titlebg">', $txt['wireless_navigation'], '</p>
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $scripturl, '?wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>', empty($context['links']['next']) ? '' : '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/next.gif" width="12" height="12"><a href="' . $context['links']['next'] . ';wap2" accesskey="#">' . $txt['wireless_navigation_next'] . '</a></p>', empty($context['links']['prev']) ? '' : '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back.gif" width="12" height="12"><a href="' . $context['links']['prev'] . ';wap2" accesskey="*">' . $txt['wireless_navigation_prev'] . '</a></p>', $context['can_send_pm'] ? '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/compose.gif" width="12" height="12"><a href="' . $scripturl . '?action=pm;sa=send;wap2">' . $txt['new_message'] . '</a></p>' : '';
	}
	else
	{
		$message = $context['get_pmessage']();
...
echo'
			<p class="titlebg">', $txt['wireless_navigation'], '</p>
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/back_home.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;start=', $context['start'], ';l=', $context['current_label_id'], ';wap2" accesskey="0">', $txt['wireless_navigation_up'], '</a></p>';
			if ($context['can_send_pm'])
				echo '
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/reply.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;sa=send;pmsg=', $message['id'], ';u=', $message['member']['id'], ';reply;wap2">', $txt['wireless_pm_reply'], '</a></p>';
echo'
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/forward.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;wap2">', $txt['forwardpm'] , '</a></p>';

echo'
			<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/deletepm.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;sa=pmactions;pm_actions[', $message['id'], ']=delete;f=', $context['folder'], ';start=', $context['start'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';', $context['session_var'], '=', $context['session_id'], ';wap2">', $txt['deletepm'] ,'</a></p>';
}
}
...
{
	global $context, $settings, $options, $scripturl, $board, $txt, $member;

	echo '
		<p class="catbg">', $txt['summary'], ' - ', $context['member']['name'], '</p>
		<p class="windowbg">', $context['member']['avatar']['image'], '</p>
		<p class="windowbg"><b>', $txt['name'], ':</b> ', $context['member']['name'], ' </p>';
		 if ($context['allow_pm'])
		echo'
		<p class="windowbg"><span id="userstatus">', $context['can_send_pm'] ? '<a href="' . $context['member']['online']['href'] . '" title="' . $context['member']['online']['label'] . '" rel="nofollow">' : '', $settings['use_image_buttons'] ? '<img src="' . $context['member']['online']['image_href'] . '" alt="' . $context['member']['online']['text'] . '" align="middle" />' : $context['member']['online']['text'], $context['can_send_pm'] ? '</a>' : '', $settings['use_image_buttons'] ? '<span class="smalltext"> ' . $context['member']['online']['text'] . '</span></p>' : '', '
		<p class="windowbg"><b>', $txt['position'], ': </b>', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '</p>
		<p class="windowbg"><b>', $txt['profile_posts'], ': </b><i>', $context['member']['posts'], ' (', $context['member']['posts_per_day'], ' ', $txt['posts_per_day'], ')</i><br/></p>
		<p class="windowbg"><b>', $txt['personal_text'], ': </b><i>', $context['member']['blurb'], '</i><br/></p>
		<p class="windowbg"><b>', $txt['lastLoggedIn'], ':</b> ', $context['member']['last_login'], '</p>
		<p class="windowbg"><b>', $txt['who_action'], ': </b> <span', $context['member']['is_hidden'] ? ' style="font-style: italic;"' : '', '>', $context['member']['action'], '</span></p>
		<p class="windowbg"><b>', $txt['email'], ': </b><i><a href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], ';wap2">', $context['member']['email'], '</a></i><br/></p>
		<p class="windowbg"><b>', $txt['website'] ,':</b><a href="', $context['member']['website']['url'], '">', $context['member']['website']['url'], '</a></p>
		<p class="windowbg"><b>', $txt['gender'], '</b>: <i>', $context['member']['gender']['name'], '</i><br/></p>
		<p class="windowbg"><b>', $txt['age'], ':</b><i>', $context['member']['age'] . ($context['member']['today_is_birthday'] ? ' &nbsp; <img src="' . $settings['images_url'] . '/bdaycake.gif" width="40" alt="" />' : ''), '</i><br/></p>
		<p class="windowbg"><b>', $txt['location'], ':</b><i>', $context['member']['location'], '</i><br/></p>
		<p class="windowbg"><b>', $txt['icq'], ':</b><i>', $context['member']['icq']['link_text'], '</i></p>
		<p class="windowbg"><b>', $txt['aim'], ': </b><i>', $context['member']['aim']['link_text'], '</i></p>
		<p class="windowbg"><b>', $txt['msn'], ': </b><i>', $context['member']['msn']['link_text'], '</i></p>
		<p class="windowbg"><b>', $txt['yim'], ': </b><i>', $context['member']['yim']['link_text'], '</i></p>';
	...
	if (!$context['user']['is_owner'] && $context['can_send_pm'])
		echo '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/compose.gif" width="12" height="12"><a href="', $scripturl, '?action=pm;sa=send;u=', $context['id_member'], ';wap2">', $txt['wireless_profile_pm'], '.</a></p>';

	if (!$context['user']['is_owner'] && !empty($context['can_edit_ban']))
		echo '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/ban.gif" width="12" height="12"><a href="', $scripturl, '?action=admin;area=ban;sa=add;u=', $context['id_member'], ';wap2">', $txt['profileBanUser'], '.</a></p>';

	echo '
		<p class="windowbg"><img border="0" src="/forums/Themes/default/images/wap/home.gif" width="12" height="12"><a href="', $scripturl, '?wap2">', $txt['wireless_error_home'], '.</a></p>';
...
echo'
<div class="wapmenu">
        <center><a href="', $scripturl, '?action=unread;wap2">', $txt['wireless_recent_unread_posts'], '</a> | <a href="', $scripturl, '?action=unreadreplies;wap2">', $txt['wireless_recent_unread_replies'], '</a></center>';

echo'
                </div><center>', $txt['footer'], '</center>
...
function site_logo()
{
	global $context, $settings, $txt, $options;
global $settings;
echo '<img src="',$txt['WAPimgURL'], '" style="margin: 0px;" alt="', $txt['WAPsiteNAME'], '" width="320px" height="48px">';
}
function ubbcode($posting) {
        ...
        $posting=eregi_replace("\[/i\]","</em>",$posting);
        $posting=eregi_replace("\&#0312;","",$posting);
